...
namespace MTConnect
{
    ...
    public class Adapter
    {
        ...
        /// <summary>
        /// A flag indicating that the heartbeats are active, meaning we've
        /// received our first * PING
        /// </summary>
        bool mHeartbeatActive = false;
        ...
        private void Receive(Stream aClient, String aLine)
        {
            ...
            try
            {
                while (mRunning && tcpClient.Connected)
                {
                    ...
                    try
                    {
                        ...
                        if (mHeartbeat > 0 && mHeartbeatActive)
                            Socket.Select(readList, null, null, mHeartbeat * 20000000);
                        if (readList.Count == 0 && mHeartbeatActive)
                        {
